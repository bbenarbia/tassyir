					...
					<div id="leftcolumn">
						<div id="carrousel">
							<c:if test="${empty user.photo }">
								<img width="340" height="240"  src='<c:url value="/resources/graphics/no-photos.jpg"/>' class="previewimg">
							</c:if>
							<c:if test="${not empty user.photo }">
								<img width="340" height="240" src="${photoUrl}/${user.id}" class="previewimg">
							</c:if>
						</div>
					</div>
					<div id="rightcolumn">
