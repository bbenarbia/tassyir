						...
						<form:form modelAttribute="bien" method="put" id="form1">
							<table class="edit_form_user" style="width: 100%; border: none;">
							 ...
							 <tr>
								...
								<tr>
									<td class="label"><form:label path="jardin"><spring:message code="biens.jardin" /></form:label></td>
									<td><label> 
										<form:checkbox path="jardin" />									
									</label></td>
									<td class="label"><form:label path="piscine"><spring:message code="biens.piscine" /></form:label></td>
										<td><label> 
