var MONTH_LIST = new Array("janvier", "fevrier", "mars", "avril", "mai", "juin", "juillet", "aout", "septembre", "octobre", "novembre", "decembre");
...
function addYearDiv(calendarDiv) {
    ...
    var table =  document.createElement("TABLE");
    table.className = "caly";
    table.border = "1";
    table.width = "240";
    var subRow;
    var subCell;
    for (i = 0; i < 5; i++) {
        subRow = table.insertRow(i);
        subRow.style.height = "18";
        for (j = 0; j < 5; j++) {
            subCell = subRow.insertCell(j);
