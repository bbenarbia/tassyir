...
public class BienDTO {
	...
	public BienDTO(Appartement appartement) {
		this(appartement.getId(), appartement.getName(), appartement
				...
				.getDepartement().getCodePostal(), appartement.getDepartement()
				.getName(), appartement.getDepartement().getReference(),
				appartement.getDescription(), appartement.getSuperficie(),
				appartement.getStatus(), appartement.getPrixVente(),
				appartement.getPrixMinVente(), appartement.getLoyerMensuel(),
				appartement.getChargesMensuel(), appartement.getTypeOperation()
						.toString(), appartement.getEtatBien(), appartement
						.getEtage(), appartement.getNbPieces(), appartement
						.getNbChambres(), appartement.isAscenseur(),
				appartement.isCuisineEquipee(), null, appartement.getAge(),
				appartement.getTypeBien(), appartement.getNbTerrasses(),
				appartement.getNbBalcons(), appartement.getNbParkingInt(),
				appartement.getNbParkingExt(), appartement.isInterphone(),
				appartement.isDigicode(), appartement.isGardien(), appartement
						.getConsoEnergie(), appartement.getTypeEauChaude(),
				appartement.getImpactConso(), appartement.getNatureChauffage(),
				appartement.getTypeChauffage(), appartement.isMeuble(),
				...
				appartement.getDateMiseAjour(), appartement.isValidated(),
				false, appartement.isEauPotable(), appartement.isGaz(),
				appartement.isToDelete(), appartement.getWhyDelete(),
				appartement.getUnitePrix().getAbreviation(), appartement
						.getUniteSuperficie().getAbreviation());
	}

	public BienDTO(Terrain terrain) {
		this(terrain.getId(), terrain.getName(), terrain.getReference(),
				terrain.getAdresse(), terrain.getDepartement().getCodePostal(),
				terrain.getDepartement().getName(), terrain.getDepartement()
						.getReference(), terrain.getDescription(), terrain
						.getSuperficie(), terrain.getStatus(), terrain
						.getPrixVente(), terrain.getPrixMinVente(), terrain
						.getLoyerMensuel(), terrain.getChargesMensuel(),
				terrain.getTypeOperation().toString(), terrain.getEtatBien(),
				null, 0, 0, false, false, false, 0, terrain.getTypeBien(), 0,
				0, 0, 0, false, false, false, null, null, null, null, null,
				false, terrain.getTransport(), terrain.isAdapteHandicape(),
				terrain.getProximite(), terrain.getHonoraires(), terrain
						.getDepotGarantie(), terrain.getNbSallesBains(),
				terrain.getNbCaves(), false, terrain.getPhotos(), terrain
						.getDateMiseAjour(), terrain.isValidated(), false,
				terrain.isEauPotable(), terrain.isGaz(), terrain.isToDelete(),
				terrain.getWhyDelete(), terrain.getUnitePrix().getAbreviation(), terrain
						.getUniteSuperficie().getAbreviation());
	}

	public BienDTO(Vacances vacances) {
		this(vacances.getId(), vacances.getName(), vacances.getReference(),
				vacances.getAdresse(), vacances.getDepartement()
						.getCodePostal(), vacances.getDepartement().getName(),
				vacances.getDepartement().getReference(), vacances
						.getDescription(), vacances.getSuperficie(), vacances
						.getStatus(), vacances.getPrixVente(), vacances
						.getPrixMinVente(), vacances.getLoyerMensuel(),
				vacances.getChargesMensuel(), vacances.getTypeOperation()
						.toString(), vacances.getEtatBien(), null, 0, 0, false,
				false, false, 0, vacances.getTypeBien(), 0, 0, 0, 0, false,
				false, false, null, null, null, null, null, false, vacances
						.getTransport(), vacances.isAdapteHandicape(), vacances
						.getProximite(), vacances.getHonoraires(), vacances
						.getDepotGarantie(), vacances.getNbSallesBains(),
				vacances.getNbCaves(), false, vacances.getPhotos(), vacances
						.getDateMiseAjour(), vacances.isValidated(), false,
				vacances.isEauPotable(), vacances.isGaz(), vacances
						.isToDelete(), vacances.getWhyDelete(), vacances
						.getUnitePrix().getAbreviation(), vacances.getUniteSuperficie()
						.getAbreviation());
	}

	public BienDTO(Agricole agricole) {
		this(agricole.getId(), agricole.getName(), agricole.getReference(),
				agricole.getAdresse(), agricole.getDepartement()
						.getCodePostal(), agricole.getDepartement().getName(),
				agricole.getDepartement().getReference(), agricole
						.getDescription(), agricole.getSuperficie(), agricole
						.getStatus(), agricole.getPrixVente(), agricole
						.getPrixMinVente(), agricole.getLoyerMensuel(),
				agricole.getChargesMensuel(), agricole.getTypeOperation()
						.toString(), agricole.getEtatBien(), null, 0, 0, false,
				false, false, 0, agricole.getTypeBien(), 0, 0, 0, 0, false,
				false, false, null, null, null, null, null, false, agricole
						.getTransport(), agricole.isAdapteHandicape(), agricole
						.getProximite(), agricole.getHonoraires(), agricole
						.getDepotGarantie(), agricole.getNbSallesBains(),
				agricole.getNbCaves(), false, agricole.getPhotos(), agricole
						.getDateMiseAjour(), agricole.isValidated(), agricole
						.isPuit(), agricole.isEauPotable(), agricole.isGaz(),
				agricole.isToDelete(), agricole.getWhyDelete(), agricole
						.getUnitePrix().getAbreviation(), agricole.getUniteSuperficie()
						.getAbreviation());
	}

	public BienDTO(Carcasse carcasse) {
		this(carcasse.getId(), carcasse.getName(), carcasse.getReference(),
				carcasse.getAdresse(), carcasse.getDepartement()
						.getCodePostal(), carcasse.getDepartement().getName(),
				carcasse.getDepartement().getReference(), carcasse
						.getDescription(), carcasse.getSuperficie(), carcasse
						.getStatus(), carcasse.getPrixVente(), carcasse
						.getPrixMinVente(), carcasse.getLoyerMensuel(),
				carcasse.getChargesMensuel(), carcasse.getTypeOperation()
						.toString(), carcasse.getEtatBien(), null, 0, 0, null,
				false, false, 0, carcasse.getTypeBien(), 0, 0, 0, 0, false,
				false, null, null, null, null, null, null, false, carcasse
						.getTransport(), carcasse.isAdapteHandicape(), carcasse
						.getProximite(), carcasse.getHonoraires(), carcasse
						.getDepotGarantie(), carcasse.getNbSallesBains(),
				carcasse.getNbCaves(), false, carcasse.getPhotos(), carcasse
						.getDateMiseAjour(), carcasse.isValidated(), false,
				carcasse.isEauPotable(), carcasse.isGaz(), carcasse
						.isToDelete(), carcasse.getWhyDelete(), carcasse
						.getUnitePrix().getAbreviation(), carcasse.getUniteSuperficie()
						.getAbreviation());
	}

	public BienDTO(Commerce commerce) {
		this(commerce.getId(), commerce.getName(), commerce.getReference(),
				commerce.getAdresse(), commerce.getDepartement()
						.getCodePostal(), commerce.getDepartement().getName(),
				commerce.getDepartement().getReference(), commerce
						.getDescription(), commerce.getSuperficie(), commerce
						.getStatus(), commerce.getPrixVente(), commerce
						.getPrixMinVente(), commerce.getLoyerMensuel(),
				commerce.getChargesMensuel(), commerce.getTypeOperation()
						.toString(), commerce.getEtatBien(), null, 0, 0, null,
				false, false, commerce.getAge(), commerce.getTypeBien(), 0, 0,
				0, 0, false, false, null, null, null, null, null, null, false,
				commerce.getTransport(), commerce.isAdapteHandicape(), commerce
						.getProximite(), commerce.getHonoraires(), commerce
						.getDepotGarantie(), commerce.getNbSallesBains(),
				commerce.getNbCaves(), false, commerce.getPhotos(), commerce
						.getDateMiseAjour(), commerce.isValidated(), false,
				commerce.isEauPotable(), commerce.isGaz(), commerce
						.isToDelete(), commerce.getWhyDelete(), commerce
						.getUnitePrix().getAbreviation(), commerce.getUniteSuperficie()
						.getAbreviation());
	}

	public BienDTO(Maison maison) {
		this(maison.getId(), maison.getName(), maison.getReference(), maison
				.getAdresse(), maison.getDepartement().getCodePostal(), maison
				.getDepartement().getName(), maison.getDepartement()
				.getReference(), maison.getDescription(), maison
				.getSuperficie(), maison.getStatus(), maison.getPrixVente(),
				maison.getPrixMinVente(), maison.getLoyerMensuel(), maison
						.getChargesMensuel(), maison.getTypeOperation()
						.toString(), maison.getEtatBien(), null, maison
						.getNbPieces(), maison.getNbChambres(), null, maison
						.isCuisineEquipee(), maison.isJardin(),
				maison.getAge(), maison.getTypeBien(), maison.getNbTerrasses(),
				maison.getNbBalcons(), maison.getNbParkingInt(), maison
						.getNbParkingExt(), maison.isInterphone(), maison
						.isDigicode(), null, maison.getConsoEnergie(), maison
						.getTypeEauChaude(), maison.getImpactConso(), maison
						.getNatureChauffage(), maison.getTypeChauffage(),
				maison.isMeuble(), maison.getTransport(), maison
						.isAdapteHandicape(), maison.getProximite(), maison
						.getHonoraires(), maison.getDepotGarantie(), maison
						.getNbSallesBains(), maison.getNbCaves(), maison
						.isPiscine(), maison.getPhotos(), maison
						.getDateMiseAjour(), maison.isValidated(), false,
				maison.isEauPotable(), maison.isGaz(), maison.isToDelete(),
				maison.getWhyDelete(), maison.getUnitePrix().getAbreviation(), maison
						.getUniteSuperficie().getAbreviation());
	}

	public BienDTO(Studio studio) {
		this(studio.getId(), studio.getName(), studio.getReference(), studio
				.getAdresse(), studio.getDepartement().getCodePostal(), studio
				.getDepartement().getName(), studio.getDepartement()
				.getReference(), studio.getDescription(), studio
				.getSuperficie(), studio.getStatus(), studio.getPrixVente(),
				studio.getPrixMinVente(), studio.getLoyerMensuel(), studio
						.getChargesMensuel(), studio.getTypeOperation()
						.toString(), studio.getEtatBien(), studio.getEtage(),
				0, 0, studio.isAscenseur(), null, null, studio.getAge(), studio
						...
						.getConsoEnergie(), studio.getTypeEauChaude(), studio
						.getImpactConso(), studio.getNatureChauffage(), studio
						.getTypeChauffage(), studio.isMeuble(), studio
						...
						.getNbCaves(), false, studio.getPhotos(), studio
						.getDateMiseAjour(), studio.isValidated(), false,
				studio.isEauPotable(), studio.isGaz(), studio.isToDelete(),
				studio.getWhyDelete(), studio.getUnitePrix().getAbreviation(), studio
						.getUniteSuperficie().getAbreviation());
	}
	...
	public BienDTO(Long id, String name, String reference, String adresse,
			...
			double prixVente, double prixVenteMin, double loyerMensuel,
			double chargesMensuel, String typeOperation, EnumEtatBien etatBien,
			...
			EnumConsEnergie consoEnergie, EnumTypeEauChaude typeEauChaude,
			EnumImpactConso impactConso, EnumNatureChauffage natureChauffage,
			EnumTypeChauffage typeChauffage, Boolean meuble, String transport,
			Boolean adapteHandicape, String proximite, double honoraires,
			double depotGarantie, int nbSallesBains, int nbCaves,
			Boolean piscine, Set<Photo> photos, LocalDateTime dateMiseAjour,
			boolean validated, Boolean puit, Boolean eauPotable, Boolean gaz,
			boolean toDelete, String whyDelete, String unitePrix,
		...
		this.shortDescription = description.substring(0,
	...
	public Appartement updateAppartement(Appartement appartement) {
		...
		if (typeEauChaude != null) {
			appartement.setTypeEauChaude(EnumTypeEauChaude
					.valueOf(typeEauChaude));
		}
		...
		if (typeChauffage != null) {
			appartement.setTypeChauffage(EnumTypeChauffage
					.valueOf(typeChauffage));
		}
